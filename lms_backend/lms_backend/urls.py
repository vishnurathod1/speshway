...
urlpatterns = [
    path('admin/about.html', TemplateView.as_view(template_name='admin/about.html'), name='admin_about_page'),
    path('admin/courses.html', TemplateView.as_view(template_name='admin/courses.html'), name='admin_courses_page'),
    path('admin/materials.html', TemplateView.as_view(template_name='admin/materials.html'), name='admin_materials_page'),
    path('admin/add course.html', TemplateView.as_view(template_name='admin/add course.html'), name='admin_add_course_page'),
    path('admin/add student.html', TemplateView.as_view(template_name='admin/add student.html'), name='admin_add_student_page'),
    path('admin/add trainer.html', TemplateView.as_view(template_name='admin/add trainer.html'), name='admin_add_trainer_page'),
    path('admin/analytics.html', TemplateView.as_view(template_name='admin/analytics.html'), name='admin_analytics_page'),
    path('admin/assignments.html', TemplateView.as_view(template_name='admin/assignments.html'), name='admin_assignments_page'),
    path('admin/attendance.html', TemplateView.as_view(template_name='admin/attendance.html'), name='admin_attendance_page'),
    path('admin/complaints.html', TemplateView.as_view(template_name='admin/complaints.html'), name='admin_complaints_page'),
    path('admin/contact.html', TemplateView.as_view(template_name='admin/contact.html'), name='admin_contact_page'),
    path('admin/live classes.html', TemplateView.as_view(template_name='admin/live classes.html'), name='admin_live_classes_page'),
    path('admin/notifications.html', TemplateView.as_view(template_name='admin/notifications.html'), name='admin_notifications_page'),
    path('admin/recorded classes.html', TemplateView.as_view(template_name='admin/recorded classes.html'), name='admin_recorded_classes_page'),
    path('admin/reports.html', TemplateView.as_view(template_name='admin/reports.html'), name='admin_reports_page'),
    path('admin/settings.html', TemplateView.as_view(template_name='admin/settings.html'), name='admin_settings_page'),
    path('admin/students.html', TemplateView.as_view(template_name='admin/students.html'), name='admin_students_page'),
    path('admin/trainer-attendance.html', TemplateView.as_view(template_name='admin/trainer-attendance.html'), name='admin_trainer_attendance_page'),
    path('admin/trainers.html', TemplateView.as_view(template_name='admin/trainers.html'), name='admin_trainers_page'),
    path('admin/users.html', TemplateView.as_view(template_name='admin/users.html'), name='admin_users_page'),
